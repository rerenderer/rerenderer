...
fun doNew(vars: Map<String, Any?>, data: New): Any = when {
    ...
    (data.cls == "RectF" && data.args.count() == 4) -> RectF(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    ...
    (data.cls == "Rect" && data.args.count() == 4) -> Rect(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    ...
    (data.cls == "Region" && data.args.count() == 4) -> Region(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    ...
    (data.cls == "Paint" && data.args.count() == 1) -> Paint(data.args.get(0) as Int)
...
fun doCall(vars: Map<String, Any?>, data: Call): Any = when {
    ...
    (data.objVar is Path && data.method == "addArc" && data.args.count() == 3) -> data.objVar.addArc(data.args.get(0) as RectF, data.args.get(1) as Float, data.args.get(2) as Float)
    (data.objVar is Path && data.method == "addArc" && data.args.count() == 6) -> data.objVar.addArc(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Float)
    (data.objVar is Path && data.method == "addCircle" && data.args.count() == 4) -> data.objVar.addCircle(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Path.Direction)
    (data.objVar is Path && data.method == "addOval" && data.args.count() == 5) -> data.objVar.addOval(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Path.Direction)
    ...
    (data.objVar is Path && data.method == "addPath" && data.args.count() == 3) -> data.objVar.addPath(data.args.get(0) as Path, data.args.get(1) as Float, data.args.get(2) as Float)
    ...
    (data.objVar is Path && data.method == "addRect" && data.args.count() == 5) -> data.objVar.addRect(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Path.Direction)
    ...
    (data.objVar is Path && data.method == "addRoundRect" && data.args.count() == 7) -> data.objVar.addRoundRect(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Float, data.args.get(6) as Path.Direction)
    (data.objVar is Path && data.method == "addRoundRect" && data.args.count() == 6) -> data.objVar.addRoundRect(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as FloatArray, data.args.get(5) as Path.Direction)
    ...
    (data.objVar is Path && data.method == "addRoundRect" && data.args.count() == 4) -> data.objVar.addRoundRect(data.args.get(0) as RectF, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Path.Direction)
    (data.objVar is Path && data.method == "arcTo" && data.args.count() == 7) -> data.objVar.arcTo(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Float, data.args.get(6) as Boolean)
    (data.objVar is Path && data.method == "arcTo" && data.args.count() == 3) -> data.objVar.arcTo(data.args.get(0) as RectF, data.args.get(1) as Float, data.args.get(2) as Float)
    (data.objVar is Path && data.method == "arcTo" && data.args.count() == 4) -> data.objVar.arcTo(data.args.get(0) as RectF, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Boolean)
    ...
    (data.objVar is Path && data.method == "cubicTo" && data.args.count() == 6) -> data.objVar.cubicTo(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Float)
    (data.objVar is Path && data.method == "getFillType" && data.args.count() == 0) -> data.objVar.getFillType()
    (data.objVar is Path && data.method == "incReserve" && data.args.count() == 1) -> data.objVar.incReserve(data.args.get(0) as Int)
    ...
    (data.objVar is Path && data.method == "lineTo" && data.args.count() == 2) -> data.objVar.lineTo(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Path && data.method == "moveTo" && data.args.count() == 2) -> data.objVar.moveTo(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Path && data.method == "offset" && data.args.count() == 3) -> data.objVar.offset(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Path)
    (data.objVar is Path && data.method == "offset" && data.args.count() == 2) -> data.objVar.offset(data.args.get(0) as Float, data.args.get(1) as Float)
    ...
    (data.objVar is Path && data.method == "quadTo" && data.args.count() == 4) -> data.objVar.quadTo(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Path && data.method == "rCubicTo" && data.args.count() == 6) -> data.objVar.rCubicTo(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Float)
    (data.objVar is Path && data.method == "rLineTo" && data.args.count() == 2) -> data.objVar.rLineTo(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Path && data.method == "rMoveTo" && data.args.count() == 2) -> data.objVar.rMoveTo(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Path && data.method == "rQuadTo" && data.args.count() == 4) -> data.objVar.rQuadTo(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    ...
    (data.objVar is Path && data.method == "setLastPoint" && data.args.count() == 2) -> data.objVar.setLastPoint(data.args.get(0) as Float, data.args.get(1) as Float)
    ...
    (data.objVar is Picture && data.method == "beginRecording" && data.args.count() == 2) -> data.objVar.beginRecording(data.args.get(0) as Int, data.args.get(1) as Int)
    ...
    (data.objVar == "Typeface" && data.method == "create" && data.args.count() == 2) -> Typeface.create(data.args.get(0) as String, data.args.get(1) as Int)
    (data.objVar == "Typeface" && data.method == "create" && data.args.count() == 2) -> Typeface.create(data.args.get(0) as Typeface, data.args.get(1) as Int)
    ...
    (data.objVar == "Typeface" && data.method == "defaultFromStyle" && data.args.count() == 1) -> Typeface.defaultFromStyle(data.args.get(0) as Int)
    (data.objVar is Typeface && data.method == "equals" && data.args.count() == 1) -> data.objVar.equals(data.args.get(0) as Object)
    ...
    (data.objVar is Canvas && data.method == "clipRect" && data.args.count() == 4) -> data.objVar.clipRect(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    (data.objVar is Canvas && data.method == "clipRect" && data.args.count() == 4) -> data.objVar.clipRect(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Canvas && data.method == "clipRect" && data.args.count() == 1) -> data.objVar.clipRect(data.args.get(0) as RectF)
    (data.objVar is Canvas && data.method == "clipRect" && data.args.count() == 5) -> data.objVar.clipRect(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Region.Op)
    ...
    (data.objVar is Canvas && data.method == "drawARGB" && data.args.count() == 4) -> data.objVar.drawARGB(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    (data.objVar is Canvas && data.method == "drawArc" && data.args.count() == 5) -> data.objVar.drawArc(data.args.get(0) as RectF, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Boolean, data.args.get(4) as Paint)
    (data.objVar is Canvas && data.method == "drawArc" && data.args.count() == 8) -> data.objVar.drawArc(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Float, data.args.get(6) as Boolean, data.args.get(7) as Paint)
    (data.objVar is Canvas && data.method == "drawBitmap" && data.args.count() == 9) -> data.objVar.drawBitmap(data.args.get(0) as IntArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Int, data.args.get(6) as Int, data.args.get(7) as Boolean, data.args.get(8) as Paint)
    ...
    (data.objVar is Canvas && data.method == "drawBitmap" && data.args.count() == 9) -> data.objVar.drawBitmap(data.args.get(0) as IntArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int, data.args.get(4) as Int, data.args.get(5) as Int, data.args.get(6) as Int, data.args.get(7) as Boolean, data.args.get(8) as Paint)
    ...
    (data.objVar is Canvas && data.method == "drawBitmap" && data.args.count() == 4) -> data.objVar.drawBitmap(data.args.get(0) as Bitmap, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Paint)
    ...
    (data.objVar is Canvas && data.method == "drawBitmapMesh" && data.args.count() == 8) -> data.objVar.drawBitmapMesh(data.args.get(0) as Bitmap, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as FloatArray, data.args.get(4) as Int, data.args.get(5) as IntArray, data.args.get(6) as Int, data.args.get(7) as Paint)
    (data.objVar is Canvas && data.method == "drawCircle" && data.args.count() == 4) -> data.objVar.drawCircle(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Paint)
    (data.objVar is Canvas && data.method == "drawColor" && data.args.count() == 1) -> data.objVar.drawColor(data.args.get(0) as Int)
    (data.objVar is Canvas && data.method == "drawColor" && data.args.count() == 2) -> data.objVar.drawColor(data.args.get(0) as Int, data.args.get(1) as PorterDuff.Mode)
    (data.objVar is Canvas && data.method == "drawLine" && data.args.count() == 5) -> data.objVar.drawLine(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Paint)
    ...
    (data.objVar is Canvas && data.method == "drawLines" && data.args.count() == 4) -> data.objVar.drawLines(data.args.get(0) as FloatArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Paint)
    (data.objVar is Canvas && data.method == "drawOval" && data.args.count() == 5) -> data.objVar.drawOval(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Paint)
    ...
    (data.objVar is Canvas && data.method == "drawPoint" && data.args.count() == 3) -> data.objVar.drawPoint(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Paint)
    (data.objVar is Canvas && data.method == "drawPoints" && data.args.count() == 4) -> data.objVar.drawPoints(data.args.get(0) as FloatArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Paint)
    ...
    (data.objVar is Canvas && data.method == "drawPosText" && data.args.count() == 5) -> data.objVar.drawPosText(data.args.get(0) as CharArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as FloatArray, data.args.get(4) as Paint)
    ...
    (data.objVar is Canvas && data.method == "drawRGB" && data.args.count() == 3) -> data.objVar.drawRGB(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int)
    (data.objVar is Canvas && data.method == "drawRect" && data.args.count() == 5) -> data.objVar.drawRect(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Paint)
    ...
    (data.objVar is Canvas && data.method == "drawRoundRect" && data.args.count() == 7) -> data.objVar.drawRoundRect(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Float, data.args.get(6) as Paint)
    (data.objVar is Canvas && data.method == "drawRoundRect" && data.args.count() == 4) -> data.objVar.drawRoundRect(data.args.get(0) as RectF, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Paint)
    (data.objVar is Canvas && data.method == "drawText" && data.args.count() == 4) -> data.objVar.drawText(data.args.get(0) as String, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Paint)
    (data.objVar is Canvas && data.method == "drawText" && data.args.count() == 6) -> data.objVar.drawText(data.args.get(0) as CharSequence, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Paint)
    (data.objVar is Canvas && data.method == "drawText" && data.args.count() == 6) -> data.objVar.drawText(data.args.get(0) as CharArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Paint)
    ...
    (data.objVar is Canvas && data.method == "quickReject" && data.args.count() == 5) -> data.objVar.quickReject(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Canvas.EdgeType)
    ...
    (data.objVar is Canvas && data.method == "restoreToCount" && data.args.count() == 1) -> data.objVar.restoreToCount(data.args.get(0) as Int)
    (data.objVar is Canvas && data.method == "rotate" && data.args.count() == 1) -> data.objVar.rotate(data.args.get(0) as Float)
    (data.objVar is Canvas && data.method == "rotate" && data.args.count() == 3) -> data.objVar.rotate(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float)
    (data.objVar is Canvas && data.method == "save" && data.args.count() == 0) -> data.objVar.save()
    (data.objVar is Canvas && data.method == "save" && data.args.count() == 1) -> data.objVar.save(data.args.get(0) as Int)
    (data.objVar is Canvas && data.method == "saveLayer" && data.args.count() == 3) -> data.objVar.saveLayer(data.args.get(0) as RectF, data.args.get(1) as Paint, data.args.get(2) as Int)
    ...
    (data.objVar is Canvas && data.method == "saveLayer" && data.args.count() == 5) -> data.objVar.saveLayer(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Paint)
    (data.objVar is Canvas && data.method == "saveLayer" && data.args.count() == 6) -> data.objVar.saveLayer(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Paint, data.args.get(5) as Int)
    (data.objVar is Canvas && data.method == "saveLayerAlpha" && data.args.count() == 3) -> data.objVar.saveLayerAlpha(data.args.get(0) as RectF, data.args.get(1) as Int, data.args.get(2) as Int)
    (data.objVar is Canvas && data.method == "saveLayerAlpha" && data.args.count() == 2) -> data.objVar.saveLayerAlpha(data.args.get(0) as RectF, data.args.get(1) as Int)
    (data.objVar is Canvas && data.method == "saveLayerAlpha" && data.args.count() == 6) -> data.objVar.saveLayerAlpha(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Int, data.args.get(5) as Int)
    (data.objVar is Canvas && data.method == "saveLayerAlpha" && data.args.count() == 5) -> data.objVar.saveLayerAlpha(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float, data.args.get(4) as Int)
    (data.objVar is Canvas && data.method == "scale" && data.args.count() == 2) -> data.objVar.scale(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Canvas && data.method == "scale" && data.args.count() == 4) -> data.objVar.scale(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Canvas && data.method == "setBitmap" && data.args.count() == 1) -> data.objVar.setBitmap(data.args.get(0) as Bitmap)
    (data.objVar is Canvas && data.method == "setDensity" && data.args.count() == 1) -> data.objVar.setDensity(data.args.get(0) as Int)
    ...
    (data.objVar is Canvas && data.method == "skew" && data.args.count() == 2) -> data.objVar.skew(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Canvas && data.method == "translate" && data.args.count() == 2) -> data.objVar.translate(data.args.get(0) as Float, data.args.get(1) as Float)
    ...
    (data.objVar is Bitmap && data.method == "compress" && data.args.count() == 3) -> data.objVar.compress(data.args.get(0) as Bitmap.CompressFormat, data.args.get(1) as Int, data.args.get(2) as OutputStream)
    ...
    (data.objVar == "Bitmap" && data.method == "createBitmap" && data.args.count() == 5) -> Bitmap.createBitmap(data.args.get(0) as DisplayMetrics, data.args.get(1) as IntArray, data.args.get(2) as Int, data.args.get(3) as Int, data.args.get(4) as Bitmap.Config)
    (data.objVar == "Bitmap" && data.method == "createBitmap" && data.args.count() == 7) -> Bitmap.createBitmap(data.args.get(0) as DisplayMetrics, data.args.get(1) as IntArray, data.args.get(2) as Int, data.args.get(3) as Int, data.args.get(4) as Int, data.args.get(5) as Int, data.args.get(6) as Bitmap.Config)
    (data.objVar == "Bitmap" && data.method == "createBitmap" && data.args.count() == 5) -> Bitmap.createBitmap(data.args.get(0) as Bitmap, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int, data.args.get(4) as Int)
    (data.objVar == "Bitmap" && data.method == "createBitmap" && data.args.count() == 1) -> Bitmap.createBitmap(data.args.get(0) as Bitmap)
    (data.objVar == "Bitmap" && data.method == "createBitmap" && data.args.count() == 4) -> Bitmap.createBitmap(data.args.get(0) as DisplayMetrics, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Bitmap.Config)
    (data.objVar == "Bitmap" && data.method == "createBitmap" && data.args.count() == 7) -> Bitmap.createBitmap(data.args.get(0) as Bitmap, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int, data.args.get(4) as Int, data.args.get(5) as Matrix, data.args.get(6) as Boolean)
    (data.objVar == "Bitmap" && data.method == "createBitmap" && data.args.count() == 3) -> Bitmap.createBitmap(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Bitmap.Config)
    (data.objVar == "Bitmap" && data.method == "createBitmap" && data.args.count() == 6) -> Bitmap.createBitmap(data.args.get(0) as IntArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int, data.args.get(4) as Int, data.args.get(5) as Bitmap.Config)
    (data.objVar == "Bitmap" && data.method == "createBitmap" && data.args.count() == 4) -> Bitmap.createBitmap(data.args.get(0) as IntArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Bitmap.Config)
    (data.objVar == "Bitmap" && data.method == "createScaledBitmap" && data.args.count() == 4) -> Bitmap.createScaledBitmap(data.args.get(0) as Bitmap, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Boolean)
    (data.objVar is Bitmap && data.method == "describeContents" && data.args.count() == 0) -> data.objVar.describeContents()
    (data.objVar is Bitmap && data.method == "eraseColor" && data.args.count() == 1) -> data.objVar.eraseColor(data.args.get(0) as Int)
    ...
    (data.objVar is Bitmap && data.method == "getPixel" && data.args.count() == 2) -> data.objVar.getPixel(data.args.get(0) as Int, data.args.get(1) as Int)
    (data.objVar is Bitmap && data.method == "getPixels" && data.args.count() == 7) -> data.objVar.getPixels(data.args.get(0) as IntArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int, data.args.get(4) as Int, data.args.get(5) as Int, data.args.get(6) as Int)
    ...
    (data.objVar is Bitmap && data.method == "getScaledHeight" && data.args.count() == 1) -> data.objVar.getScaledHeight(data.args.get(0) as Int)
    ...
    (data.objVar is Bitmap && data.method == "getScaledWidth" && data.args.count() == 1) -> data.objVar.getScaledWidth(data.args.get(0) as Int)
    ...
    (data.objVar is Bitmap && data.method == "reconfigure" && data.args.count() == 3) -> data.objVar.reconfigure(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Bitmap.Config)
    ...
    (data.objVar is Bitmap && data.method == "setDensity" && data.args.count() == 1) -> data.objVar.setDensity(data.args.get(0) as Int)
    ...
    (data.objVar is Bitmap && data.method == "setHeight" && data.args.count() == 1) -> data.objVar.setHeight(data.args.get(0) as Int)
    (data.objVar is Bitmap && data.method == "setPixel" && data.args.count() == 3) -> data.objVar.setPixel(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int)
    (data.objVar is Bitmap && data.method == "setPixels" && data.args.count() == 7) -> data.objVar.setPixels(data.args.get(0) as IntArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int, data.args.get(4) as Int, data.args.get(5) as Int, data.args.get(6) as Int)
    ...
    (data.objVar is Bitmap && data.method == "setWidth" && data.args.count() == 1) -> data.objVar.setWidth(data.args.get(0) as Int)
    (data.objVar is Bitmap && data.method == "writeToParcel" && data.args.count() == 2) -> data.objVar.writeToParcel(data.args.get(0) as Parcel, data.args.get(1) as Int)
    ...
    (data.objVar is RectF && data.method == "contains" && data.args.count() == 4) -> data.objVar.contains(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is RectF && data.method == "contains" && data.args.count() == 2) -> data.objVar.contains(data.args.get(0) as Float, data.args.get(1) as Float)
    ...
    (data.objVar is RectF && data.method == "equals" && data.args.count() == 1) -> data.objVar.equals(data.args.get(0) as Object)
    ...
    (data.objVar is RectF && data.method == "offset" && data.args.count() == 2) -> data.objVar.offset(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is RectF && data.method == "offsetTo" && data.args.count() == 2) -> data.objVar.offsetTo(data.args.get(0) as Float, data.args.get(1) as Float)
    ...
    (data.objVar is RectF && data.method == "set" && data.args.count() == 4) -> data.objVar.set(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    ...
    (data.objVar is RectF && data.method == "union" && data.args.count() == 4) -> data.objVar.union(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is RectF && data.method == "union" && data.args.count() == 1) -> data.objVar.union(data.args.get(0) as RectF)
    (data.objVar is RectF && data.method == "union" && data.args.count() == 2) -> data.objVar.union(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is RectF && data.method == "width" && data.args.count() == 0) -> data.objVar.width()
    (data.objVar is RectF && data.method == "writeToParcel" && data.args.count() == 2) -> data.objVar.writeToParcel(data.args.get(0) as Parcel, data.args.get(1) as Int)
    ...
    (data.objVar is Matrix && data.method == "equals" && data.args.count() == 1) -> data.objVar.equals(data.args.get(0) as Object)
    ...
    (data.objVar is Matrix && data.method == "mapPoints" && data.args.count() == 5) -> data.objVar.mapPoints(data.args.get(0) as FloatArray, data.args.get(1) as Int, data.args.get(2) as FloatArray, data.args.get(3) as Int, data.args.get(4) as Int)
    ...
    (data.objVar is Matrix && data.method == "mapRadius" && data.args.count() == 1) -> data.objVar.mapRadius(data.args.get(0) as Float)
    ...
    (data.objVar is Matrix && data.method == "mapVectors" && data.args.count() == 5) -> data.objVar.mapVectors(data.args.get(0) as FloatArray, data.args.get(1) as Int, data.args.get(2) as FloatArray, data.args.get(3) as Int, data.args.get(4) as Int)
    (data.objVar is Matrix && data.method == "postConcat" && data.args.count() == 1) -> data.objVar.postConcat(data.args.get(0) as Matrix)
    (data.objVar is Matrix && data.method == "postRotate" && data.args.count() == 1) -> data.objVar.postRotate(data.args.get(0) as Float)
    (data.objVar is Matrix && data.method == "postRotate" && data.args.count() == 3) -> data.objVar.postRotate(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float)
    (data.objVar is Matrix && data.method == "postScale" && data.args.count() == 2) -> data.objVar.postScale(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Matrix && data.method == "postScale" && data.args.count() == 4) -> data.objVar.postScale(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Matrix && data.method == "postSkew" && data.args.count() == 4) -> data.objVar.postSkew(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Matrix && data.method == "postSkew" && data.args.count() == 2) -> data.objVar.postSkew(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Matrix && data.method == "postTranslate" && data.args.count() == 2) -> data.objVar.postTranslate(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Matrix && data.method == "preConcat" && data.args.count() == 1) -> data.objVar.preConcat(data.args.get(0) as Matrix)
    (data.objVar is Matrix && data.method == "preRotate" && data.args.count() == 1) -> data.objVar.preRotate(data.args.get(0) as Float)
    (data.objVar is Matrix && data.method == "preRotate" && data.args.count() == 3) -> data.objVar.preRotate(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float)
    (data.objVar is Matrix && data.method == "preScale" && data.args.count() == 2) -> data.objVar.preScale(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Matrix && data.method == "preScale" && data.args.count() == 4) -> data.objVar.preScale(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Matrix && data.method == "preSkew" && data.args.count() == 4) -> data.objVar.preSkew(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Matrix && data.method == "preSkew" && data.args.count() == 2) -> data.objVar.preSkew(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Matrix && data.method == "preTranslate" && data.args.count() == 2) -> data.objVar.preTranslate(data.args.get(0) as Float, data.args.get(1) as Float)
    ...
    (data.objVar is Matrix && data.method == "setPolyToPoly" && data.args.count() == 5) -> data.objVar.setPolyToPoly(data.args.get(0) as FloatArray, data.args.get(1) as Int, data.args.get(2) as FloatArray, data.args.get(3) as Int, data.args.get(4) as Int)
    ...
    (data.objVar is Matrix && data.method == "setRotate" && data.args.count() == 1) -> data.objVar.setRotate(data.args.get(0) as Float)
    (data.objVar is Matrix && data.method == "setRotate" && data.args.count() == 3) -> data.objVar.setRotate(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float)
    (data.objVar is Matrix && data.method == "setScale" && data.args.count() == 4) -> data.objVar.setScale(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Matrix && data.method == "setScale" && data.args.count() == 2) -> data.objVar.setScale(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Matrix && data.method == "setSinCos" && data.args.count() == 2) -> data.objVar.setSinCos(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Matrix && data.method == "setSinCos" && data.args.count() == 4) -> data.objVar.setSinCos(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Matrix && data.method == "setSkew" && data.args.count() == 4) -> data.objVar.setSkew(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Float)
    (data.objVar is Matrix && data.method == "setSkew" && data.args.count() == 2) -> data.objVar.setSkew(data.args.get(0) as Float, data.args.get(1) as Float)
    (data.objVar is Matrix && data.method == "setTranslate" && data.args.count() == 2) -> data.objVar.setTranslate(data.args.get(0) as Float, data.args.get(1) as Float)
    ...
    (data.objVar is Rect && data.method == "contains" && data.args.count() == 2) -> data.objVar.contains(data.args.get(0) as Int, data.args.get(1) as Int)
    (data.objVar is Rect && data.method == "contains" && data.args.count() == 4) -> data.objVar.contains(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    ...
    (data.objVar is Rect && data.method == "equals" && data.args.count() == 1) -> data.objVar.equals(data.args.get(0) as Object)
    ...
    (data.objVar is Rect && data.method == "inset" && data.args.count() == 2) -> data.objVar.inset(data.args.get(0) as Int, data.args.get(1) as Int)
    (data.objVar is Rect && data.method == "intersect" && data.args.count() == 1) -> data.objVar.intersect(data.args.get(0) as Rect)
    (data.objVar is Rect && data.method == "intersect" && data.args.count() == 4) -> data.objVar.intersect(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    (data.objVar is Rect && data.method == "intersects" && data.args.count() == 4) -> data.objVar.intersects(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    (data.objVar is Rect && data.method == "intersects" && data.args.count() == 2) -> data.objVar.intersects(data.args.get(0) as Rect, data.args.get(1) as Rect)
    (data.objVar is Rect && data.method == "isEmpty" && data.args.count() == 0) -> data.objVar.isEmpty()
    (data.objVar is Rect && data.method == "offset" && data.args.count() == 2) -> data.objVar.offset(data.args.get(0) as Int, data.args.get(1) as Int)
    (data.objVar is Rect && data.method == "offsetTo" && data.args.count() == 2) -> data.objVar.offsetTo(data.args.get(0) as Int, data.args.get(1) as Int)
    (data.objVar is Rect && data.method == "readFromParcel" && data.args.count() == 1) -> data.objVar.readFromParcel(data.args.get(0) as Parcel)
    (data.objVar is Rect && data.method == "set" && data.args.count() == 4) -> data.objVar.set(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    ...
    (data.objVar is Rect && data.method == "union" && data.args.count() == 4) -> data.objVar.union(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    (data.objVar is Rect && data.method == "union" && data.args.count() == 1) -> data.objVar.union(data.args.get(0) as Rect)
    (data.objVar is Rect && data.method == "union" && data.args.count() == 2) -> data.objVar.union(data.args.get(0) as Int, data.args.get(1) as Int)
    (data.objVar is Rect && data.method == "width" && data.args.count() == 0) -> data.objVar.width()
    (data.objVar is Rect && data.method == "writeToParcel" && data.args.count() == 2) -> data.objVar.writeToParcel(data.args.get(0) as Parcel, data.args.get(1) as Int)
    ...
    (data.objVar is Region && data.method == "contains" && data.args.count() == 2) -> data.objVar.contains(data.args.get(0) as Int, data.args.get(1) as Int)
    (data.objVar is Region && data.method == "describeContents" && data.args.count() == 0) -> data.objVar.describeContents()
    (data.objVar is Region && data.method == "equals" && data.args.count() == 1) -> data.objVar.equals(data.args.get(0) as Object)
    ...
    (data.objVar is Region && data.method == "op" && data.args.count() == 5) -> data.objVar.op(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int, data.args.get(4) as Region.Op)
    ...
    (data.objVar is Region && data.method == "quickContains" && data.args.count() == 4) -> data.objVar.quickContains(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    (data.objVar is Region && data.method == "quickContains" && data.args.count() == 1) -> data.objVar.quickContains(data.args.get(0) as Rect)
    (data.objVar is Region && data.method == "quickReject" && data.args.count() == 4) -> data.objVar.quickReject(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    ...
    (data.objVar is Region && data.method == "set" && data.args.count() == 4) -> data.objVar.set(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    ...
    (data.objVar is Region && data.method == "translate" && data.args.count() == 3) -> data.objVar.translate(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Region)
    (data.objVar is Region && data.method == "translate" && data.args.count() == 2) -> data.objVar.translate(data.args.get(0) as Int, data.args.get(1) as Int)
    (data.objVar is Region && data.method == "union" && data.args.count() == 1) -> data.objVar.union(data.args.get(0) as Rect)
    (data.objVar is Region && data.method == "writeToParcel" && data.args.count() == 2) -> data.objVar.writeToParcel(data.args.get(0) as Parcel, data.args.get(1) as Int)
    (data.objVar is Color && data.method == "HSVToColor" && data.args.count() == 1) -> data.objVar.HSVToColor(data.args.get(0) as FloatArray)
    (data.objVar is Color && data.method == "HSVToColor" && data.args.count() == 2) -> data.objVar.HSVToColor(data.args.get(0) as Int, data.args.get(1) as FloatArray)
    (data.objVar is Color && data.method == "RGBToHSV" && data.args.count() == 4) -> data.objVar.RGBToHSV(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as FloatArray)
    (data.objVar is Color && data.method == "alpha" && data.args.count() == 1) -> data.objVar.alpha(data.args.get(0) as Int)
    (data.objVar is Color && data.method == "argb" && data.args.count() == 4) -> data.objVar.argb(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    (data.objVar is Color && data.method == "blue" && data.args.count() == 1) -> data.objVar.blue(data.args.get(0) as Int)
    (data.objVar is Color && data.method == "colorToHSV" && data.args.count() == 2) -> data.objVar.colorToHSV(data.args.get(0) as Int, data.args.get(1) as FloatArray)
    (data.objVar is Color && data.method == "green" && data.args.count() == 1) -> data.objVar.green(data.args.get(0) as Int)
    (data.objVar is Color && data.method == "parseColor" && data.args.count() == 1) -> data.objVar.parseColor(data.args.get(0) as String)
    (data.objVar is Color && data.method == "red" && data.args.count() == 1) -> data.objVar.red(data.args.get(0) as Int)
    (data.objVar is Color && data.method == "rgb" && data.args.count() == 3) -> data.objVar.rgb(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int)
    (data.objVar is Paint && data.method == "ascent" && data.args.count() == 0) -> data.objVar.ascent()
    (data.objVar is Paint && data.method == "breakText" && data.args.count() == 5) -> data.objVar.breakText(data.args.get(0) as CharArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Float, data.args.get(4) as FloatArray)
    (data.objVar is Paint && data.method == "breakText" && data.args.count() == 6) -> data.objVar.breakText(data.args.get(0) as CharSequence, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Boolean, data.args.get(4) as Float, data.args.get(5) as FloatArray)
    (data.objVar is Paint && data.method == "breakText" && data.args.count() == 4) -> data.objVar.breakText(data.args.get(0) as String, data.args.get(1) as Boolean, data.args.get(2) as Float, data.args.get(3) as FloatArray)
    ...
    (data.objVar is Paint && data.method == "getTextBounds" && data.args.count() == 4) -> data.objVar.getTextBounds(data.args.get(0) as CharArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Rect)
    (data.objVar is Paint && data.method == "getTextBounds" && data.args.count() == 4) -> data.objVar.getTextBounds(data.args.get(0) as String, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Rect)
    (data.objVar is Paint && data.method == "getTextLocale" && data.args.count() == 0) -> data.objVar.getTextLocale()
    (data.objVar is Paint && data.method == "getTextPath" && data.args.count() == 6) -> data.objVar.getTextPath(data.args.get(0) as CharArray, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Path)
    (data.objVar is Paint && data.method == "getTextPath" && data.args.count() == 6) -> data.objVar.getTextPath(data.args.get(0) as String, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Float, data.args.get(4) as Float, data.args.get(5) as Path)
    ...
    (data.objVar is Paint && data.method == "getTextWidths" && data.args.count() == 4) -> data.objVar.getTextWidths(data.args.get(0) as String, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as FloatArray)
    ...
    (data.objVar is Paint && data.method == "getTextWidths" && data.args.count() == 4) -> data.objVar.getTextWidths(data.args.get(0) as CharSequence, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as FloatArray)
    ...
    (data.objVar is Paint && data.method == "measureText" && data.args.count() == 3) -> data.objVar.measureText(data.args.get(0) as CharSequence, data.args.get(1) as Int, data.args.get(2) as Int)
    (data.objVar is Paint && data.method == "measureText" && data.args.count() == 3) -> data.objVar.measureText(data.args.get(0) as String, data.args.get(1) as Int, data.args.get(2) as Int)
    (data.objVar is Paint && data.method == "measureText" && data.args.count() == 3) -> data.objVar.measureText(data.args.get(0) as CharArray, data.args.get(1) as Int, data.args.get(2) as Int)
    ...
    (data.objVar is Paint && data.method == "setARGB" && data.args.count() == 4) -> data.objVar.setARGB(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    (data.objVar is Paint && data.method == "setAlpha" && data.args.count() == 1) -> data.objVar.setAlpha(data.args.get(0) as Int)
    (data.objVar is Paint && data.method == "setAntiAlias" && data.args.count() == 1) -> data.objVar.setAntiAlias(data.args.get(0) as Boolean)
    (data.objVar is Paint && data.method == "setColor" && data.args.count() == 1) -> data.objVar.setColor(data.args.get(0) as Int)
    ...
    (data.objVar is Paint && data.method == "setFlags" && data.args.count() == 1) -> data.objVar.setFlags(data.args.get(0) as Int)
    ...
    (data.objVar is Paint && data.method == "setHinting" && data.args.count() == 1) -> data.objVar.setHinting(data.args.get(0) as Int)
    (data.objVar is Paint && data.method == "setLetterSpacing" && data.args.count() == 1) -> data.objVar.setLetterSpacing(data.args.get(0) as Float)
    ...
    (data.objVar is Paint && data.method == "setShadowLayer" && data.args.count() == 4) -> data.objVar.setShadowLayer(data.args.get(0) as Float, data.args.get(1) as Float, data.args.get(2) as Float, data.args.get(3) as Int)
    ...
    (data.objVar is Paint && data.method == "setStrokeMiter" && data.args.count() == 1) -> data.objVar.setStrokeMiter(data.args.get(0) as Float)
    (data.objVar is Paint && data.method == "setStrokeWidth" && data.args.count() == 1) -> data.objVar.setStrokeWidth(data.args.get(0) as Float)
    ...
    (data.objVar is Paint && data.method == "setTextScaleX" && data.args.count() == 1) -> data.objVar.setTextScaleX(data.args.get(0) as Float)
    (data.objVar is Paint && data.method == "setTextSize" && data.args.count() == 1) -> data.objVar.setTextSize(data.args.get(0) as Float)
    (data.objVar is Paint && data.method == "setTextSkewX" && data.args.count() == 1) -> data.objVar.setTextSkewX(data.args.get(0) as Float)

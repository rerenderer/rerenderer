...
fun doCall(vars: Map<String, Any?>, data: Call): Any = when {
    ...
    (data.objVar == "Color" && data.method == "HSVToColor" && data.args.count() == 2) -> Color.HSVToColor(data.args.get(0) as Int, data.args.get(1) as FloatArray)
    (data.objVar == "Color" && data.method == "RGBToHSV" && data.args.count() == 4) -> Color.RGBToHSV(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as FloatArray)
    (data.objVar == "Color" && data.method == "alpha" && data.args.count() == 1) -> Color.alpha(data.args.get(0) as Int)
    (data.objVar == "Color" && data.method == "argb" && data.args.count() == 4) -> Color.argb(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int, data.args.get(3) as Int)
    (data.objVar == "Color" && data.method == "blue" && data.args.count() == 1) -> Color.blue(data.args.get(0) as Int)
    (data.objVar == "Color" && data.method == "colorToHSV" && data.args.count() == 2) -> Color.colorToHSV(data.args.get(0) as Int, data.args.get(1) as FloatArray)
    (data.objVar == "Color" && data.method == "green" && data.args.count() == 1) -> Color.green(data.args.get(0) as Int)
    (data.objVar == "Color" && data.method == "parseColor" && data.args.count() == 1) -> Color.parseColor(data.args.get(0) as String)
    (data.objVar == "Color" && data.method == "red" && data.args.count() == 1) -> Color.red(data.args.get(0) as Int)
    (data.objVar == "Color" && data.method == "rgb" && data.args.count() == 3) -> Color.rgb(data.args.get(0) as Int, data.args.get(1) as Int, data.args.get(2) as Int)
